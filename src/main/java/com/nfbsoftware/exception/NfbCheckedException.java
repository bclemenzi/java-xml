...
public abstract class NfbCheckedException extends Exception
{
     ...
     */
    private static final Map<String, Code> CODE_MAP = new HashMap<>(31);
    ...
    /**
     * Represents a <code>checkedException</code> code. This class is used to
    ...
    /**
     * Returns the message based upon the error code and arguments provided
    ...
    /** Returns <code>true</code> if severity of this exception is ERROR or FATAL. Returns <code>false</code> otherwise.
     *
     * @return <code>true</code> if the severity of this exception is ERROR or FATAL; <code>false</code> otherwise.
     */
    ...
    /**
     * Gets the MediaMateCheckedException.Code object with the corresponding
     ...
     * deserializaion using the standard deserialization tools, then calls autoLog().
     *
